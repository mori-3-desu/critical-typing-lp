  ...
  return (
    <>
      ...
      <div className="w-full flex justify-between items-center bg-white/10 backdrop-blur-md py-4 px-6 rounded-2xl border border-white/20 shadow-xl mb-6 md:mb-10">
        <h1 className="text-2xl md:text-3xl font-bold tracking-wider text-transparent bg-clip-text bg-linear-to-r from-cyan-200 to-blue-400 drop-shadow-sm flex items-center gap-2">
          {title}
        </h1>
